...
<x-filament-panels::page>
    ...
    <style>
        ...
        .availability-modern-calendar [data-availability-state="free"]::after { color: rgb(21 128 61) !important; }
        .availability-modern-calendar [data-availability-state="busy"]::after { color: rgb(185 28 28) !important; }
        ...
        .dark .availability-modern-calendar [data-availability-state="free"]::after { color: rgb(134 239 172) !important; }
        .dark .availability-modern-calendar [data-availability-state="busy"]::after { color: rgb(252 165 165) !important; }
